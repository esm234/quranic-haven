...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen pt-20 fade-in-elements">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-6 text-right">تواصل معنا</h1>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="glass p-6 rounded-xl fade-in-elements">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium">+966 54 33 100 24</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium">contact@quranapp.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-muted-foreground">وسائل التواصل</p>
                  <div className="flex items-center gap-2 mt-1">
                    <a href="https://www.instagram.com/kl.7_5?igsh=b3NudXNzYXBrYTd2&utm_source=qr" className="hover:text-primary transition-colors">
